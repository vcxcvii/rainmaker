...
Copied verbatim into every judgment skill. Do not paraphrase it, and do not
localise it per skill. The point is that 26 skills load the same context the
same way, so the system holds one opinion rather than 26.
